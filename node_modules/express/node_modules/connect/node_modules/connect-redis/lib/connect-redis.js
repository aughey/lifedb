...
module.exports = function(connect){
  ...
  RedisStore.prototype.set = function(sid, sess, fn){
    try {
      ...
      client.set(sid + ':access', lastAccess);
      client.sadd('connect:sessions', sid);
      client.setex(sid, ttl, sess, function(){
  ...
  RedisStore.prototype.destroy = function(sid, fn){
    this.client.srem('connect:sessions', sid);
    this.client.del(sid + ':access');
